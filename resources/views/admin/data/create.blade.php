                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">اضافه البيانات
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">اضافه البيانات  </h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{ route('admin.store.data') }}" method="POST"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div id="activity_row" class="form-group" style="visibility: hidden;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div id="mission_row" class="form-group" style="visibility: hidden">
                                                            ...
                                                            <optgroup label="من فضلك اختر المهمه">
                                                                ...
                                                                @if(isset($missions) && $missions -> count() > 0)
                                                                    @foreach($missions as $mission)
                                                                        <option
                                                                            value="{{$mission -> id }}">{{$mission -> name}}</option>
                                                                    @endforeach
                                                                @endif
                                                            </optgroup>
                                                        </select>
