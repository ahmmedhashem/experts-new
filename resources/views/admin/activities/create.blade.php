                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.activities') }}"> الانشطه </a>
                            </li>
                            <li class="breadcrumb-item active">اضافه نشاط جديد
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">اضافه نشاط جديد </h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{ route('admin.store.activity') }}" method="POST"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="" id="name"
                                                            class="form-control"
                                                            placeholder="من فضلك ادخل اسم النشاط"
                                                            name="name">
                                                            @error("name")
